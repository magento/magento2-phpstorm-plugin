...
class MagentoBlockCommandsTest : BaseProjectTestCase() {
    @Test
    fun testCreateMagentoBlockCreatesBlockClass() {
        val result = MagentoBlockCommands.createMagentoBlock(
            project = project,
            moduleName = "Foo_Bar",
            blockClassFqn = "Foo\\Bar\\Block\\McpTestBlock"
        )

        PlatformTestUtil.dispatchAllEventsInIdeEventQueue()
        IndexingTestUtil.waitUntilIndexesAreReady(project)

        assertContains(result, "Created Magento block class \"Foo\\Bar\\Block\\McpTestBlock\".")
        assertContainsPath(result, "app/code/Foo/Bar/Block/McpTestBlock.php")

        assertFileContains(
            "app/code/Foo/Bar/Block/McpTestBlock.php",
            "class McpTestBlock extends Template"
        )
        assertFileContains(
            "app/code/Foo/Bar/Block/McpTestBlock.php",
