...
class WelcomeFrame(remoteRobot: RemoteRobot, remoteComponent: RemoteComponent) : CommonContainerFixture(remoteRobot, remoteComponent) {
    val createNewProjectFromExistingFilesLink
        get() = actionLink(byXpath("//div[@defaulticon='open.svg']"))
    val trustProjectLink
        get() = actionLink(byXpath("//div[@text='Trust Project']"))
}