...
import com.magento.idea.magento2plugin.magento.files.ModuleExtensionAttributesXmlFile;
...
public class NewExtensionAttributesXmlAction extends AbstractContextAction {
     ...
     */
    public NewExtensionAttributesXmlAction() {
        super(ACTION_NAME, ACTION_DESCRIPTION, new ModuleExtensionAttributesXmlFile());
    }
