...
public class NewControllerValidator {
    ...
    public boolean validate()
    {
        ...
        if (!PhpNameUtil.isValidClassName(actionName)) {
            String errorMessage = this.validatorBundle.message("validator.class.isNotValid", "Action Name");
        ...
        if (actionName.length() == 0) {
            String errorMessage = this.validatorBundle.message("validator.notEmpty", "Action Name");
            JOptionPane.showMessageDialog(null, errorMessage, errorTitle, JOptionPane.ERROR_MESSAGE);
        ...
        if (!actionName.matches(RegExUtil.ALPHANUMERIC)) {
            String errorMessage = this.validatorBundle.message("validator.alphaNumericCharacters", "Action Name");
            JOptionPane.showMessageDialog(null, errorMessage, errorTitle, JOptionPane.ERROR_MESSAGE);

            return false;
        }

        if (!Character.isUpperCase(actionName.charAt(0)) && !Character.isDigit(actionName.charAt(0))) {
