...
public class OverrideLayoutInThemeAction extends DumbAwareAction {
    public static String actionName = "Override this layout in a project theme";
    ...
    public void update(final @NotNull AnActionEvent event) {
        ...
        if (Settings.isEnabled(project)) {
            try {
                if (Objects.requireNonNull(psiFile.getFileElementType()).getLanguage().getID().equals("XML")) {
